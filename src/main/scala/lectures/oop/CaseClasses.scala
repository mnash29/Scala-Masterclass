...
object CaseClasses extends App {
  ...
  case object EmptyGenericList extends GenericCollection[Nothing] {
  ...
  case class GenericCollectionList[+A](h: A, t: GenericCollection[A]) extends GenericCollection[A] {
